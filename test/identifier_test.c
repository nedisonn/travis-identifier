...
void TestandoMain_ComecandoComNumero(){
    int aux;
    aux = system("echo '123oi' | ./identifier");
    TEST_ASSERT_EQUAL_INT_MESSAGE(256, aux, "It is supposed to start with a letter");
}

void TestandoMain_ComecandoComLetraSucesso(){
    int aux;
    aux = system("echo 'oi1234' | ./identifier");
    TEST_ASSERT_EQUAL_INT_MESSAGE(0, aux, "It is supposed to  be valid");
}

void TestandoMain_ComecandoComLetraApenasLetrasSucesso(){
    int aux;
    aux = system("echo 'Yasmin' | ./identifier");
    TEST_ASSERT_EQUAL_INT_MESSAGE(0, aux, "It is supposed to be valid");
}

void TestandoMain_ComecandoComLetraComNumerosInvalido(){
    int aux;
...
void TestandoMain_ComecandoComLetraApenasLetrasInvalido(){
    int aux;
